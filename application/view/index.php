  ...
  <body>
    <div id="banner">
      <div id="banner-content">
        ...
        <a href="application/view/v_registro.php">REGISTRO</a>
        <a href="application/view/v_login.php">LOGIN</a>

      </div>
    </div>
    <div id="main-content">
      <h2>Phutbol Manager - Mánager de Fútbol Online</h2>
